<%@ Page Language="VB" MasterPageFile="~/GMechMaster.master" AutoEventWireup="false" CodeFile="ChargeTypeMaint.aspx.vb" Inherits="ChargeTypeMaint" title="Maintain Charge Types" %>
   ...
   <asp:ScriptManager ID="ScriptManager1" EnablePartialRendering="true" runat="server" />
                ...
                <table class="TabPanelTable">
                            ...
                            <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                <tr>
                                    <td align="center" width="100%" class="tableCaptionLabel" colspan="2">
                                        Charge Type Maintenance <asp:Label ID="lblChargeNumber" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr valign="top">
                                    <td colspan="2">
                                        ...
                                        <asp:GridView ID="gvLookupTable" runat="server" AllowPaging="True" RowStyle-VerticalAlign="Top"
                                            ...
                                            <Columns>
                                               <asp:TemplateField HeaderText="Actions">
                                                ...
                                                <asp:TemplateField HeaderText="ChargeType" SortExpression="ChargeType">
                                                    <FooterTemplate>
                                                        <asp:TextBox ID="ChargeType" runat="server" Width="95%" Text='<%# Bind("ChargeType") %>'></asp:TextBox>
                                                    </FooterTemplate>
                                                    <EditItemTemplate>
                 ...
                 <asp:SqlDataSource ID="sqldsLookupTableData" runat="server" ConnectionString="<%$ ConnectionStrings:CaseMgmtConnectionString %>" 
                    ...
                    InsertCommand="InsertChargeTypes" InsertCommandType="StoredProcedure"  
                    UpdateCommand="UpdateChargeTypes" UpdateCommandType="StoredProcedure">
                     <InsertParameters>
