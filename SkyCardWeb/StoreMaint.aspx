<%@ Page Language="VB" MasterPageFile="~/GMechMaster.master" AutoEventWireup="false" CodeFile="StoreMaint.aspx.vb" Inherits="StoreMaint" title="Maintain Stores" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" EnablePartialRendering="true" runat="server" />
                ...
                <table class="TabPanelTable">
                                ...
                                <tr valign="top">
                                    <td colspan="2">
                                      ...
                                      <asp:GridView ID="gvLookupTable" runat="server" AllowPaging="True" RowStyle-VerticalAlign="Top"
                                            AllowSorting="True" Width="100%" PageSize="20" DataSourceID="sqldsLookupTableData" DataKeyNames="storeid"
                                            ...
                                            <Columns>
                                               <asp:TemplateField HeaderText="Actions">
                                                ...
                                                <asp:TemplateField HeaderText="Store Name" SortExpression="storename">
                                                    <FooterTemplate>
                                                        <asp:TextBox ID="storename" runat="server" Text='<%# Bind("storename")%>'></asp:TextBox>
                                                    </FooterTemplate>
                                                    <EditItemTemplate>
                 ...
                 <asp:SqlDataSource ID="sqldsLookupTableData" runat="server" ConnectionString="<%$ ConnectionStrings:CaseMgmtConnectionString %>" 
                    ...
                    InsertCommand="InsertStore" InsertCommandType="StoredProcedure"  
                    UpdateCommand="UpdateStore" UpdateCommandType="StoredProcedure">
                     <InsertParameters>
