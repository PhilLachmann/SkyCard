<%@ Page Language="VB" MasterPageFile="~/GMechMaster.master" AutoEventWireup="false" CodeFile="RptLocationProduct.aspx.vb" Inherits="RptLocationProduct" title="Location Products Report" %>
                                    ...
                                    <td width="100%" align="center" >
                                        ...
                                        <asp:Panel ID="pnlReport" runat="server" Width="100%" >
                                            <dxxr:ReportToolbar ID="ReportToolbar1" runat='server' 
                                                ShowDefaultButtons='False' ReportViewer="<%# rptvwrLocProducts %>" Width="100%">
                                                <Items>
                                            ...
                                            <dxxr:ReportViewer ID="rptvwrLocProducts" runat="server">
                                            </dxxr:ReportViewer>
