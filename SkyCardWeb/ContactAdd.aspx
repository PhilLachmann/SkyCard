<%@ Page Language="VB" MasterPageFile="~/GMechMaster.master" AutoEventWireup="false" CodeFile="ContactAdd.aspx.vb" Inherits="ContactAdd" title="CaseMgmt" %>
                            ...
                            <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:Button ID="btnCancelContact" runat="server" Text="Cancel" />
                                    </td>
                                </tr>
                                <tr valign="top">
                                    <td colspan="2">
                                        ...
                                        <asp:DetailsView ID="dvContact" runat="server" AutoGenerateRows="False" DataKeyNames="ContactID"
                                            DefaultMode="Insert" DataSourceID="sqldsLookupTableData" 
