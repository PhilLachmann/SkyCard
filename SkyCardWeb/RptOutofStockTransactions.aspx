<%@ Page Language="VB" MasterPageFile="~/GMechMaster.master" AutoEventWireup="false" CodeFile="RptOutofStockTransactions.aspx.vb" Inherits="RptOutofStockTransactions" title="Out of Stock Transactions Report" %>
                            ...
                            <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                <tr>
                                    <td align="center" width="100%" class="tableCaptionLabel" colspan="2">
                                        Out of Stock Transactions Report
                                    </td>
                                </tr>
                                <tr valign="top">
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td align="right" width="90%">
                                                    ...
                                                    &nbsp;<asp:Label ID="Label1" runat="server" Text="Show Transactions of This Type:"></asp:Label>
                                                    <asp:SqlDataSource ID="sqldsTransTypeList" runat="server" ConnectionString="<%$ ConnectionStrings:CaseMgmtConnectionString %>" 
                                                        ProviderName="<%$ ConnectionStrings:CaseMgmtConnectionString.ProviderName %>"
                                                        SelectCommand="Call GetTransTypeList()" SelectCommandType="StoredProcedure">
                                                    </asp:SqlDataSource>
                                                    <asp:DropDownList ID="TransType" runat="server" AutoPostBack="True" DataSourceID="sqldsTransTypeList" AppendDataBoundItems="True" 
                                                            DataTextField="TransType" DataValueField="TransType" >
                                                            <asp:ListItem Text="All" Value="%" Selected="True"></asp:ListItem>
                                                    </asp:DropDownList>&nbsp;&nbsp;
                                                    <asp:Label ID="Label3" runat="server" Text="For This Job:"></asp:Label>
                                                    ...
                                                    <asp:DropDownList ID="JobID" runat="server" AutoPostBack="True" DataSourceID="sqldsJobList" AppendDataBoundItems="True" 
                                                            DataTextField="JobDesc" DataValueField="JobID" >
                                                            <asp:ListItem Text="All" Value="%" Selected="True"></asp:ListItem>
                                                    </asp:DropDownList>&nbsp;&nbsp;
                                                    <asp:Label ID="Label2" runat="server" Text="In The Date Range From:"></asp:Label>
                                    ...
                                    <td width="100%" align="center" >
                                        ...
                                        <asp:Panel ID="pnlReport" runat="server" Width="100%" Visible="False" >
                                            <dxxr:ReportToolbar ID="ReportToolbar1" runat='server' 
                                                ShowDefaultButtons='False' ReportViewer="<%# rptvwrOutStkTxns %>" Width="100%">
                                                <Items>
                                            ...
                                            <dxxr:ReportViewer ID="rptvwrOutStkTxns" runat="server">
                                            </dxxr:ReportViewer>
