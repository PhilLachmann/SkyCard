<%@ Page Language="VB" MasterPageFile="~/GMechMaster.master" AutoEventWireup="false" CodeFile="AssetByLocationFlexReport.aspx.vb" Inherits="AssetByLocationFlexReport" title="Assets By Location Report" %>
                                ...
                                <tr valign="top">
                                    <td width="100%" align="center" >
                                        ...
                                        <asp:Panel ID="pnlReport" runat="server" Width="100%" HorizontalAlign="Left" >
                                            <asp:Button ID="ExportReport" runat="server" Text="Export To Excel" OnClientClick="javascript:exportToExcel();return false;" />
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Panel ID="pnlFullSize" runat="server" Visible="true" Height="10px" Width="100px" >
