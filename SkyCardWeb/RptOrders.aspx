<%@ Page Language="VB" MasterPageFile="~/GMechMaster.master" AutoEventWireup="false" CodeFile="RptOrders.aspx.vb" Inherits="RptOrders" title="Order Report" %>
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" width="80%">
                                                    ...
                                                    <asp:SqlDataSource ID="sqldsOrderStatusList" runat="server" ConnectionString="<%$ ConnectionStrings:CaseMgmtConnectionString %>" 
                                                        ProviderName="<%$ ConnectionStrings:CaseMgmtConnectionString.ProviderName %>"
                                                        SelectCommand="Call GetOrderStatusList()" SelectCommandType="StoredProcedure">
                                                    </asp:SqlDataSource>
