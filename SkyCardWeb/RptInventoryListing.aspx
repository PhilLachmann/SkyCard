<%@ Page Language="VB" MasterPageFile="~/GMechMaster.master" AutoEventWireup="false" CodeFile="RptInventoryListing.aspx.vb" Inherits="RptInventoryListing" title="Inventory Listing Report" %>
                                    ...
                                    <td width="100%" align="center" >
                                        <asp:Panel ID="pnlReport" runat="server" Width="100%" >
                                            ...
                                            <dxxr:ReportToolbar ID="ReportToolbar1" runat='server' 
                                                ShowDefaultButtons='False' ReportViewer="<%# rptvwrInvListing %>" Width="100%">
                                                <Items>
                                            ...
                                            <dxxr:ReportViewer ID="rptvwrInvListing" runat="server">
                                            </dxxr:ReportViewer>
