<%@ Page Language="VB" MasterPageFile="~/GMechMaster.master" AutoEventWireup="false" CodeFile="RptBillofLadingGmech.aspx.vb" Inherits="RptBillofLadingGmech" title="Bill of Lading Report" %>
                                        ...
                                        <table>
                                            <tr>
                                                <td align="left" width="20%">
                                                    <asp:Button ID="btnReturn" runat="server" Text="Return to Search Page" Width="150px"  />
                                                </td>
                                    ...
                                    <td width="100%" align="center" >
                                        ...
                                        <asp:Panel ID="pnlReport" runat="server" Width="100%" >
                                            <dxxr:ReportToolbar ID="ReportToolbar1" runat='server' 
                                                ShowDefaultButtons='False' ReportViewer="<%# rptvwrBillofLading %>" Width="100%">
                                                <Items>
                                            ...
                                            <dxxr:ReportViewer ID="rptvwrBillofLading" runat="server">
                                            </dxxr:ReportViewer>
