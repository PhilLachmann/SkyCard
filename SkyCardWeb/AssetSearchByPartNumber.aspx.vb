...
Partial Class AssetSearchByPartNumber
    ...
    Protected Sub btnQuery_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        'Session("AdjustmentsDataTable") = Nothing
    ...
    Protected Sub lvQuery_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ListViewItemEventArgs)
    ...
    Protected Sub btnRunReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRunReport.Click
        ...
        Dim findPartNumberID As String = " (select tagnameid from TagName where TagDesc = 'Part Number') "

        strWhereClause = "where 1 = 1 and deleted='N' "
        thePartNumber = tbPartNumber.Text.Trim()

        strWhereClause = strWhereClause & " and (tagnameid = " & findPartNumberID & " and TV_varchar = " & " '" & thePartNumber & "') "
