<%@ Page Language="VB" MasterPageFile="~/GMechMaster.master" AutoEventWireup="false" CodeFile="AssetSearch2.aspx.vb" Inherits="AssetSearch2" title="Search Assets" %>
                    ...
                    <tr style="vertical-align: top;">
                        <td>
                            <table cellpadding="3" cellspacing="1" border="0" width="100%">
                                ...
                                <tr valign="top">
                                    <td width="100%" class="tableCaptionLabel" colspan="2" >
                                        <table width="100%">
                                            <tr>
                                                
                                                <td align="right" width="100%">
                                                
                                                    &nbsp;<asp:Label ID="Label1" runat="server" Text="Select Report Format:"></asp:Label>&nbsp;&nbsp;
                                                    <asp:RadioButtonList ID="rblRptOutput" runat="server" TextAlign="Left" 
                                                        RepeatDirection="Horizontal" RepeatLayout="Flow">
                                                        <asp:ListItem Text="For Screen" Value="S" Selected="True"></asp:ListItem>
                                                        <asp:ListItem Text="For Printout" Value="P" ></asp:ListItem>
                                                    </asp:RadioButtonList>
                                                </td>
                                            </tr>
