<%@ Page Language="VB" MasterPageFile="~/GMechMaster.master" AutoEventWireup="false" CodeFile="PrintSubpoena.aspx.vb" Inherits="RptOutofStockPricing" title="Inventory Reorder Report" %>
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td align="left" width="20%">
                                                    <asp:Button ID="btnReturn" runat="server" Text="Return To Previous Screen"  />
                                                </td>
                                ...
                                <tr valign="top">
                                    <td width="100%" align="center" >
                                        ...
                                        <asp:Panel ID="pnlReport" runat="server" Width="100%" Visible="True" >
                                            ...
                                            <dxxr:ReportViewer ID="rptvwrReport" runat="server">
                                            </dxxr:ReportViewer>
