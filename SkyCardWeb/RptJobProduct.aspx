<%@ Page Language="VB" MasterPageFile="~/GMechMaster.master" AutoEventWireup="false" CodeFile="RptJobProduct.aspx.vb" Inherits="RptJobProduct" title="Job Products Report" %>
                                    ...
                                    <td width="100%" align="center" >
                                        <asp:Panel ID="pnlReport" runat="server" Width="100%" >
                                            ...
                                            <dxxr:ReportToolbar ID="ReportToolbar1" runat='server' 
                                                ShowDefaultButtons='False' ReportViewer="<%# rptvwrJobProducts %>" Width="100%">
                                                <Items>
                                            ...
                                            <dxxr:ReportViewer ID="rptvwrJobProducts" runat="server">
                                            </dxxr:ReportViewer>
