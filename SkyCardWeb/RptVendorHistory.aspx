<%@ Page Language="VB" MasterPageFile="~/GMechMaster.master" AutoEventWireup="false" CodeFile="RptVendorHistory.aspx.vb" Inherits="RptVendorHistory" title="Vendor History Report" %>
                                    ...
                                    <td width="100%" align="center" >
                                        ...
                                        <asp:Panel ID="pnlReport" runat="server" Width="100%" >
                                            <dxxr:ReportToolbar ID="ReportToolbar1" runat='server' 
                                                ShowDefaultButtons='False' ReportViewer="<%# rptvwrVendorHistory %>" Width="100%">
                                                <Items>
                                            ...
                                            <dxxr:ReportViewer ID="rptvwrVendorHistory" runat="server">
                                            </dxxr:ReportViewer>
